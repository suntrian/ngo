...
public final class RandomUtil {
    ...
    protected static final String NUMBERCHAR = "0123456789";
     ...
     * @return 随机字符串
     */
    public static String justString(int length) {
        StringBuffer sb = new StringBuffer();
        for (int i = 0; i < length; i++) {
     ...
     * @return 定长的字符串
     */
    public static String fixdLengthString(long num, int fixdlenth) {
        StringBuffer sb = new StringBuffer();
     ...
     * @return 定长的字符串
     */
    public static String fixdLengthString(Integer num, int fixdlenth) {
        return fixdLengthString(num.longValue(), fixdlenth);
    }
