...
public final class EmailUtil {
     ...
     */
    public EmailUtil(String mailHost, String auth, String port, String sender_username, String sender_password) {
        setProperties(mailHost, auth, port, sender_username, sender_password);
        session = Session.getInstance(properties);
        message = new MimeMessage(session);
    }

    public void setProperties(String mailHost, String auth, String port, String sender_username, String
            sender_password) {
        properties.put("mail.smtp.host", mailHost);
        properties.put("mail.smtp.auth", auth);
        properties.put("mail.smtp.port", port == null ? String.valueOf(25) : port);
